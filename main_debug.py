...
======================================================================
 ...
 PINOUT PICO v1  — etykiety tylko dla pinow uzywanych w tym pliku (★)
 Kazda linia: [30 znak prefix][9 znak pin-id][────●┤][15 wnetrze][├●────][prawa strona]
                                            ┌──[micro USB]──┐
                                            │  ● LED (GP25) │
                                            │               │
  UART0 TX ──► RX urzadz.   ★ GP0  [ 1]────●┤               ├●──── [40] VBUS  (5V z USB)
  UART0 RX ◄── TX urzadz.   ★ GP1  [ 2]────●┤               ├●──── [39] VSYS  (zasilanie)
  Masa: urzadz. + debug      ★ GND  [ 3]────■┤               ├■──── [38] GND
  CTS ◄── RTS urzadz.[opt]  ★ GP2  [ 4]────●┤               ├●──── [37] 3V3_EN
  RTS ──► CTS urzadz.[opt]  ★ GP3  [ 5]────●┤  [BOOTSEL]    ├●──── [36] 3V3 OUT (3.3V)
  UART1 TX ──► RX debug      ★ GP4  [ 6]────●┤               ├●──── [35] ADC_VREF
                              GP5  [ 7]────●┤               ├●──── [34] GP28
                              GND  [ 8]────■┤               ├■──── [33] AGND
                              GP6  [ 9]────●┤               ├●──── [32] GP27
                              GP7  [10]────●┤               ├●──── [31] GP26
